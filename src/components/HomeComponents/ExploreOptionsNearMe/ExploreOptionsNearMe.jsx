...
let ExploreOptionsNearMe = () => {
    let chain = ['delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur', 'delhi', 'cheenai', 'jabalpur']
